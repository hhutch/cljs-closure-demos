...
goog.ui = {};
goog.ui.CharCounter = function(a, b, c, d) {
  goog.events.EventTarget.call(this);
  this.elInput_ = a;
  this.elCount_ = b;
  this.maxLength_ = c;
  this.display_ = d || goog.ui.CharCounter.Display.REMAINING;
  a.maxLength = c;
  this.inputHandler_ = new goog.events.InputHandler(a);
...
goog.ui.CharCounter.Display = {REMAINING:0, INCREMENTAL:1};
goog.ui.CharCounter.prototype.setMaxLength = function(a) {
  this.maxLength_ = a;
  this.elInput_.maxLength = a;
  this.checkLength_()
};
goog.ui.CharCounter.prototype.getMaxLength = function() {
  return this.maxLength_
};
goog.ui.CharCounter.prototype.setDisplayMode = function(a) {
  this.display_ = a;
  this.checkLength_()
};
...
goog.ui.CharCounter.prototype.onChange_ = function() {
  this.checkLength_()
};
goog.ui.CharCounter.prototype.checkLength_ = function() {
  var a = this.elInput_.value.length;
  if(a > this.maxLength_) {
    var b = this.elInput_.scrollTop, c = this.elInput_.scrollLeft;
    this.elInput_.value = this.elInput_.value.substring(0, this.maxLength_);
    a = this.maxLength_;
    this.elInput_.scrollTop = b;
    this.elInput_.scrollLeft = c
  }
  this.elCount_ && goog.dom.setTextContent(this.elCount_, this.display_ == goog.ui.CharCounter.Display.INCREMENTAL ? a : this.maxLength_ - a)
};
...
var charcounter = {setup:function() {
  new goog.ui.CharCounter(goog.dom.getElement.call(null, "input1"), goog.dom.getElement.call(null, "counter1"), 160);
  new goog.ui.CharCounter(goog.dom.getElement.call(null, "input2"), goog.dom.getElement.call(null, "counter2"), 160, goog.ui.CharCounter.Display.INCREMENTAL);
  var a = new goog.ui.CharCounter(goog.dom.getElement.call(null, "input3"), goog.dom.getElement.call(null, "counter3"), 10);
  new goog.ui.CharCounter(goog.dom.getElement.call(null, "input4"), goog.dom.getElement.call(null, "counter4"), 255);
  goog.events.listen(goog.dom.getElement.call(null, "b1"), goog.events.EventType.CLICK, function() {
    return a.setMaxLength(10)
  });
  return goog.events.listen(goog.dom.getElement.call(null, "b2"), goog.events.EventType.CLICK, function() {
    return a.setMaxLength(20)
  })
}};
goog.exportSymbol("charcounter.setup", charcounter.setup);
