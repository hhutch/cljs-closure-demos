...
goog.color.alpha.parse = function(a) {
  ...
  if(goog.color.alpha.isValidAlphaHexColor_(c)) {
    ...
    if(c = goog.color.alpha.isValidRgbaColor_(a), c.length) {
      return b.hex = goog.color.alpha.rgbaArrayToHex(c), b.type = "rgba", b
    }else {
      if(c = goog.color.alpha.isValidHslaColor_(a), c.length) {
...
goog.color.alpha.normalizeAlphaHex_ = function(a) {
  ...
  a.length == 5 && (a = a.replace(goog.color.alpha.hexQuadrupletRe_, "#$1$1$2$2$3$3$4$4"));
  return a.toLowerCase()
};
...
goog.color.alpha.isValidRgbaColor_ = function(a) {
  ...
  if(b) {
    ...
    if(a >= 0 && a <= 255 && c >= 0 && c <= 255 && d >= 0 && d <= 255 && b >= 0 && b <= 1) {
      return[a, c, d, b]
    }
  }
  return[]
...
goog.color.alpha.isValidHslaColor_ = function(a) {
  ...
  if(b) {
    var a = Number(b[1]), c = Number(b[2]), d = Number(b[3]), b = Number(b[4]);
    if(a >= 0 && a <= 360 && c >= 0 && c <= 100 && d >= 0 && d <= 100 && b >= 0 && b <= 1) {
      return[a, c, d, b]
    }
  }
  return[]
...
goog.ui.HsvPalette = function(a, b, c) {
  goog.ui.Component.call(this, a);
  this.setColor_(b || "#f00");
  this.class_ = c || "goog-hsv-palette";
...
goog.ui.HsvPalette.prototype.updateInput = function() {
  var a;
  try {
    a = goog.color.parse(this.inputEl_.value).hex
  }catch(b) {
  }
  if(this.color_ != a) {
...
goog.ui.HsvPalette.prototype.setColor = function(a) {
  a != this.color_ && (this.setColor_(a), this.updateUi_(), this.dispatchEvent(goog.ui.Component.EventType.ACTION))
};
goog.ui.HsvPalette.prototype.setColor_ = function(a) {
  var a = goog.color.parse(a).hex, b = goog.color.hexToRgb(a);
  this.hsv_ = goog.color.rgbArrayToHsv(b);
  this.hsv_[0] /= 360;
  this.color_ = a
};
goog.ui.HsvPalette.prototype.setHsv = function(a, b, c) {
  if(a != null || b != null || c != null) {
    this.setHsv_(a, b, c), this.updateUi_(), this.dispatchEvent(goog.ui.Component.EventType.ACTION)
  }
};
goog.ui.HsvPalette.prototype.setHsv_ = function(a, b, c) {
  this.hsv_[0] = a != null ? a : this.hsv_[0];
  this.hsv_[1] = b != null ? b : this.hsv_[1];
  this.hsv_[2] = c != null ? c : this.hsv_[2];
  this.color_ = goog.color.hsvArrayToHex([this.hsv_[0] * 360, this.hsv_[1], this.hsv_[2]])
};
goog.ui.HsvPalette.prototype.canDecorate = function() {
  return false
};
goog.ui.HsvPalette.prototype.createDom = function() {
  var a = this.getDomHelper(), b = goog.userAgent.IE && !goog.userAgent.isVersion("7") ? " " + (this.class_ + "-noalpha") : "";
  this.setElementInternal(a.createDom(goog.dom.TagName.DIV, this.class_ + b, a.createDom(goog.dom.TagName.DIV, this.class_ + "-hs-backdrop"), this.hsImageEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-hs-image"), this.hsHandleEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-hs-handle"), this.vImageEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-v-image"), this.vHandleEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-v-handle"), this.swatchEl_ = a.createDom(goog.dom.TagName.DIV, 
  this.class_ + "-swatch"), a.createDom("label", null, this.inputEl_ = a.createDom("input", {"class":this.class_ + "-input", type:"text"}))))
};
goog.ui.HsvPalette.prototype.enterDocument = function() {
  ...
  a.listen(this.getElement(), goog.events.EventType.MOUSEDOWN, this.handleMouseDown_, false, this);
  if(!this.inputHandler_) {
    this.inputHandler_ = new goog.events.InputHandler(this.inputEl_)
  }
  a.listen(this.inputHandler_, goog.events.InputHandler.EventType.INPUT, this.handleInput_, false, this)
};
goog.ui.HsvPalette.prototype.disposeInternal = function() {
  ...
  this.inputHandler_ && (this.inputHandler_.dispose(), delete this.inputHandler_);
...
goog.ui.HsvPalette.prototype.updateUi_ = function() {
  if(this.isInDocument()) {
    var a = this.hsv_[1], b = this.hsv_[2];
    this.hsHandleEl_.style.left = this.hsImageEl_.offsetLeft - Math.floor(this.hsHandleEl_.offsetWidth / 2) + this.hsImageEl_.offsetWidth * this.hsv_[0] + "px";
    a = this.hsImageEl_.offsetTop - Math.floor(this.hsHandleEl_.offsetHeight / 2) + this.hsImageEl_.offsetHeight * (1 - a);
    this.hsHandleEl_.style.top = a + "px";
    a = this.vImageEl_.offsetTop - Math.floor(this.vHandleEl_.offsetHeight / 2) + this.vImageEl_.offsetHeight * ((255 - b) / 255);
    this.vHandleEl_.style.top = a + "px";
    goog.style.setOpacity(this.hsImageEl_, b / 255);
    ...
    goog.style.setStyle(this.swatchEl_, "color", this.hsv_[2] > 127.5 ? "#000" : "#fff");
    this.updateInput()
  }
};
goog.ui.HsvPalette.prototype.handleMouseDown_ = function(a) {
  if(a.target == this.vImageEl_ || a.target == this.vHandleEl_) {
    var b = goog.style.getBounds(this.vImageEl_);
    this.handleMouseMoveV_(b, a);
    ...
    if(a.target == this.hsImageEl_ || a.target == this.hsHandleEl_) {
      b = goog.style.getBounds(this.hsImageEl_), this.handleMouseMoveHs_(b, a), this.mouseMoveListener_ = goog.events.listen(this.document_, goog.events.EventType.MOUSEMOVE, goog.bind(this.handleMouseMoveHs_, this, b)), this.mouseUpListener_ = goog.events.listen(this.document_, goog.events.EventType.MOUSEUP, this.handleMouseUp_, false, this)
    }
  }
};
goog.ui.HsvPalette.prototype.handleMouseMoveV_ = function(a, b) {
  b.preventDefault();
  var c = this.getDomHelper().getDocumentScroll();
  this.setHsv(null, null, Math.round(255 * (a.top + a.height - Math.min(Math.max(c.y + b.clientY, a.top), a.top + a.height)) / a.height))
};
goog.ui.HsvPalette.prototype.handleMouseMoveHs_ = function(a, b) {
  b.preventDefault();
  var c = this.getDomHelper().getDocumentScroll(), d = (Math.min(Math.max(c.x + b.clientX, a.left), a.left + a.width) - a.left) / a.width, c = (-Math.min(Math.max(c.y + b.clientY, a.top), a.top + a.height) + a.top + a.height) / a.height;
  this.setHsv(d, c, null)
};
goog.ui.HsvPalette.prototype.handleMouseUp_ = function() {
  goog.events.unlistenByKey(this.mouseMoveListener_);
  goog.events.unlistenByKey(this.mouseUpListener_)
};
goog.ui.HsvPalette.prototype.handleInput_ = function() {
  /^#[0-9a-f]{6}$/i.test(this.inputEl_.value) && this.setColor(this.inputEl_.value)
};
goog.ui.HsvaPalette = function(a, b, c, d) {
  goog.ui.HsvPalette.call(this, a, b, d);
  this.alpha_ = goog.isDef(c) ? c : 1;
  this.class_ = d || "goog-hsva-palette";
  this.document_ = a ? a.getDocument() : goog.dom.getDomHelper().getDocument()
};
goog.inherits(goog.ui.HsvaPalette, goog.ui.HsvPalette);
goog.ui.HsvaPalette.prototype.getAlpha = function() {
  return this.alpha_
};
goog.ui.HsvaPalette.prototype.setAlpha = function(a) {
  this.setColorAlphaHelper_(this.color_, a)
};
goog.ui.HsvaPalette.prototype.setColor = function(a) {
  this.setColorAlphaHelper_(a, 1)
};
goog.ui.HsvaPalette.prototype.getColorRgbaHex = function() {
  var a = Math.floor(this.alpha_ * 255).toString(16);
  return this.color_ + (a.length == 1 ? "0" + a : a)
};
goog.ui.HsvaPalette.prototype.setColorRgbaHex = function(a) {
  a = goog.ui.HsvaPalette.parseColorRgbaHex_(a);
  this.setColorAlphaHelper_(a[0], a[1])
};
goog.ui.HsvaPalette.prototype.setColorAlphaHelper_ = function(a, b) {
  var c = this.color_ != a, d = this.alpha_ != b;
  this.alpha_ = b;
  this.color_ = a;
  c && goog.ui.HsvaPalette.superClass_.setColor_.call(this, a);
  if(c || d) {
    this.updateUi_(), this.dispatchEvent(goog.ui.Component.EventType.ACTION)
  }
};
goog.ui.HsvaPalette.prototype.createDom = function() {
  ...
  this.aImageEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-a-image");
  this.aHandleEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-a-handle");
  this.swatchBackdropEl_ = a.createDom(goog.dom.TagName.DIV, this.class_ + "-swatch-backdrop");
  a.appendChild(this.element_, this.aImageEl_);
  a.appendChild(this.element_, this.aHandleEl_);
  a.appendChild(this.element_, this.swatchBackdropEl_)
};
...
goog.ui.HsvaPalette.prototype.updateUi_ = function() {
  ...
  if(this.isInDocument()) {
    ...
    this.aHandleEl_.style.top = this.aImageEl_.offsetTop - Math.floor(this.aHandleEl_.offsetHeight / 2) + this.aImageEl_.offsetHeight * ((255 - a) / 255) + "px";
...
goog.ui.HsvaPalette.prototype.handleMouseDown_ = function(a) {
  goog.ui.HsvaPalette.superClass_.handleMouseDown_.call(this, a);
  if(a.target == this.aImageEl_ || a.target == this.aHandleEl_) {
    var b = goog.style.getBounds(this.vImageEl_);
    this.handleMouseMoveA_(b, a);
...
goog.ui.HsvaPalette.prototype.handleMouseMoveA_ = function(a, b) {
  b.preventDefault();
  var c = goog.dom.getPageScroll();
  this.setAlpha((a.top + a.height - Math.min(Math.max(c.y + b.clientY, a.top), a.top + a.height)) / a.height)
};
goog.ui.HsvaPalette.prototype.handleInput_ = function() {
  var a = goog.ui.HsvaPalette.parseUserInput_(this.inputEl_.value);
  a && this.setColorAlphaHelper_(a[0], a[1])
};
goog.ui.HsvaPalette.parseUserInput_ = function(a) {
  if(/^#[0-9a-f]{8}$/i.test(a)) {
    return goog.ui.HsvaPalette.parseColorRgbaHex_(a)
  }else {
...
goog.ui.HsvaPalette.parseColorRgbaHex_ = function(a) {
  a = goog.color.alpha.parse(a).hex;
  return[goog.color.alpha.extractHexColor(a), parseInt(goog.color.alpha.extractAlpha(a), 16) / 255]
};
var cljs = {core:{}};
...
var hsvapalette = {setup:function() {
  var a = new goog.ui.HsvaPalette, b = new goog.ui.HsvaPalette(null, null, null, "goog-hsva-palette-sm"), c = function(a) {
    return a.target.other.setColorRgbaHex(a.target.getColorRgbaHex())
  };
  a.render();
  b.render();
  a.other = b;
  b.other = a;
  goog.events.listen(a, goog.ui.Component.EventType.ACTION, c);
  return goog.events.listen(b, goog.ui.Component.EventType.ACTION, c)
}};
goog.exportSymbol("hsvapalette.setup", hsvapalette.setup);
