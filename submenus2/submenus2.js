...
goog.ui.SubMenuRenderer.prototype.createDom = function(a) {
  var b = goog.ui.SubMenuRenderer.superClass_.createDom.call(this, a);
  goog.dom.classes.add(b, goog.ui.SubMenuRenderer.CSS_CLASS);
  this.addArrow_(a, b);
  return b
};
goog.ui.SubMenuRenderer.prototype.decorate = function(a, b) {
  b = goog.ui.SubMenuRenderer.superClass_.decorate.call(this, a, b);
  goog.dom.classes.add(b, goog.ui.SubMenuRenderer.CSS_CLASS);
  this.addArrow_(a, b);
  var c = goog.dom.getElementsByTagNameAndClass("div", "goog-menu", b);
  if(c.length) {
    var d = new goog.ui.Menu(a.getDomHelper()), c = c[0];
...
goog.ui.SubMenuRenderer.prototype.initializeDom = function(a) {
  goog.ui.SubMenuRenderer.superClass_.initializeDom.call(this, a);
  var b = a.getContentElement(), c = a.getDomHelper().getElementsByTagNameAndClass("span", "goog-submenu-arrow", b)[0];
  goog.ui.SubMenuRenderer.setArrowTextContent_(a, c);
  c != b.lastChild && b.appendChild(c);
  goog.dom.a11y.setState(a.getElement(), goog.dom.a11y.State.HASPOPUP, "true")
};
goog.ui.SubMenuRenderer.prototype.addArrow_ = function(a, b) {
...
goog.ui.SubMenuRenderer.setArrowTextContent_ = function(a, b) {
  var c = goog.ui.SubMenuRenderer.LEFT_ARROW_, d = goog.ui.SubMenuRenderer.RIGHT_ARROW_;
  a.isRightToLeft() ? (goog.dom.classes.add(b, "goog-submenu-arrow-rtl"), goog.dom.setTextContent(b, a.isAlignedToEnd() ? c : d)) : (goog.dom.classes.remove(b, "goog-submenu-arrow-rtl"), goog.dom.setTextContent(b, a.isAlignedToEnd() ? d : c))
};
...
goog.ui.SubMenu = function(a, b, c, d) {
  goog.ui.MenuItem.call(this, a, b, c, d || goog.ui.SubMenuRenderer.getInstance())
};
...
goog.ui.SubMenu.prototype.enterDocument = function() {
  ...
  this.subMenu_ && this.setMenuListenersEnabled_(this.subMenu_, true)
};
goog.ui.SubMenu.prototype.exitDocument = function() {
  ...
  this.subMenu_ && (this.setMenuListenersEnabled_(this.subMenu_, false), this.externalSubMenu_ || (this.subMenu_.exitDocument(), goog.dom.removeNode(this.subMenu_.getElement())));
...
goog.ui.SubMenu.prototype.setHighlighted = function(a, b) {
  goog.ui.SubMenu.superClass_.setHighlighted.call(this, a);
  b && this.getMenu().setMouseButtonPressed(true);
  if(!a) {
    this.dismissTimer_ && goog.Timer.clear(this.dismissTimer_), this.dismissTimer_ = goog.Timer.callOnce(this.dismissSubMenu, goog.ui.SubMenu.MENU_DELAY_MS, this)
  }
};
goog.ui.SubMenu.prototype.showSubMenu = function() {
  var a = this.getParent();
  if(a && a.getHighlighted() == this) {
    this.setSubMenuVisible_(true), this.dismissSiblings_(), this.keyboardSetFocus_ = false
  }
};
goog.ui.SubMenu.prototype.dismissSubMenu = function() {
  var a = this.subMenu_;
  a && a.getParent() == this && (this.setSubMenuVisible_(false), a.forEachChild(function(a) {
    typeof a.dismissSubMenu == "function" && a.dismissSubMenu()
  }))
};
goog.ui.SubMenu.prototype.clearTimers = function() {
  this.dismissTimer_ && goog.Timer.clear(this.dismissTimer_);
  this.showTimer_ && goog.Timer.clear(this.showTimer_)
};
goog.ui.SubMenu.prototype.setVisible = function(a, b) {
  var c = goog.ui.SubMenu.superClass_.setVisible.call(this, a, b);
...
goog.ui.SubMenu.prototype.dismissSiblings_ = function() {
  this.getParent().forEachChild(function(a) {
    a != this && typeof a.dismissSubMenu == "function" && (a.dismissSubMenu(), a.clearTimers())
  }, this)
};
goog.ui.SubMenu.prototype.handleKeyEvent = function(a) {
  var b = a.keyCode;
  if(this.hasKeyboardControl_) {
    if(!this.getMenu().handleKeyEvent(a)) {
    ...
    if(this.isEnabled() && b == goog.events.KeyCodes.RIGHT) {
      this.showSubMenu(), this.getMenu().highlightFirst(), this.clearTimers()
    }else {
      return false
    }
  }
...
goog.ui.SubMenu.prototype.handleMouseOver = function(a) {
  if(this.isEnabled()) {
    this.clearTimers(), this.showTimer_ = goog.Timer.callOnce(this.showSubMenu, goog.ui.SubMenu.MENU_DELAY_MS, this)
  }
  goog.ui.SubMenu.superClass_.handleMouseOver.call(this, a)
};
goog.ui.SubMenu.prototype.performActionInternal = function(a) {
  this.clearTimers();
  return this.isSupportedState(goog.ui.Component.State.SELECTED) ? goog.ui.SubMenu.superClass_.performActionInternal.call(this, a) : (this.showSubMenu(), true)
};
goog.ui.SubMenu.prototype.setSubMenuVisible_ = function(a) {
  ...
  var b = this.getMenu();
  if(a != b.isVisible()) {
    a && (b.isInDocument() || b.render(), this.positionSubMenu_(), b.setHighlightedIndex(-1)), this.hasKeyboardControl_ = a, goog.dom.classes.enable(this.getElement(), "goog-submenu-open", a), b.setVisible(a)
  }
};
goog.ui.SubMenu.prototype.setMenuListenersEnabled_ = function(a, b) {
  var c = this.getHandler();
  (b ? c.listen : c.unlisten).call(c, a, goog.ui.Component.EventType.HIGHLIGHT, this.onChildHighlight_)
};
goog.ui.SubMenu.prototype.setAlignToEnd = function(a) {
  if(a != this.alignToEnd_) {
    this.alignToEnd_ = a, this.isInDocument() && (a = this.getElement(), this.exitDocument(), a.nextSibling ? this.renderBefore(a.nextSibling) : this.render(a.parentNode))
  }
};
...
goog.ui.SubMenu.prototype.positionSubMenu_ = function() {
  var a = new goog.positioning.AnchoredViewportPosition(this.getElement(), this.isAlignedToEnd() ? goog.positioning.Corner.TOP_END : goog.positioning.Corner.TOP_START, this.isPositionAdjustable_), b = this.getMenu(), c = b.getElement();
  if(!b.isVisible()) {
    c.style.visibility = "hidden", goog.style.showElement(c, true)
  }
  a.reposition(c, this.isAlignedToEnd() ? goog.positioning.Corner.TOP_START : goog.positioning.Corner.TOP_END);
  if(!b.isVisible()) {
    goog.style.showElement(c, false), c.style.visibility = "visible"
  }
};
goog.ui.SubMenu.prototype.addItem = function(a) {
  this.getMenu().addChild(a, true)
};
goog.ui.SubMenu.prototype.addItemAt = function(a, b) {
  this.getMenu().addChildAt(a, b, true)
};
goog.ui.SubMenu.prototype.removeItem = function(a) {
  (a = this.getMenu().removeChild(a, true)) && a.dispose()
};
goog.ui.SubMenu.prototype.removeItemAt = function(a) {
  (a = this.getMenu().removeChildAt(a, true)) && a.dispose()
};
goog.ui.SubMenu.prototype.getItemAt = function(a) {
...
goog.ui.SubMenu.prototype.getMenu = function() {
  this.subMenu_ ? this.externalSubMenu_ && this.subMenu_.getParent() != this && this.subMenu_.setParent(this) : this.setMenu(new goog.ui.Menu(this.getDomHelper()), true);
  this.subMenu_.getElement() || this.subMenu_.createDom();
  return this.subMenu_
};
goog.ui.SubMenu.prototype.setMenu = function(a, b) {
  var c = this.subMenu_;
  if(a != c) {
    c && (this.dismissSubMenu(), this.isInDocument() && this.setMenuListenersEnabled_(c, false)), this.subMenu_ = a, this.externalSubMenu_ = !b, a && (a.setParent(this), a.setVisible(false, true), a.setAllowAutoFocus(false), a.setFocusable(false), this.isInDocument() && this.setMenuListenersEnabled_(a, true))
  }
};
goog.ui.SubMenu.prototype.containsElement = function(a) {
  return this.getMenu().containsElement(a)
};
goog.ui.SubMenu.prototype.setPositionAdjustable = function(a) {
  this.isPositionAdjustable_ = !!a
};
goog.ui.SubMenu.prototype.isPositionAdjustable = function() {
  return this.isPositionAdjustable_
};
goog.ui.registry.setDecoratorByClassName("goog-submenu", function() {
...
goog.ui.PopupMenu = function(a, b) {
  goog.ui.Menu.call(this, a, b);
...
goog.ui.PopupMenu.prototype.enterDocument = function() {
  ...
  a.listen(this.getDomHelper().getDocument(), goog.events.EventType.MOUSEDOWN, this.onDocClick, true);
  goog.userAgent.WEBKIT && a.listen(this.getDomHelper().getDocument(), goog.events.EventType.CONTEXTMENU, this.onDocClick, true)
};
goog.ui.PopupMenu.prototype.attach = function(a, b, c, d, e) {
  this.isAttachTarget(a) || (a = this.createAttachTarget(a, b, c, d, e), this.isInDocument() && this.attachEvent_(a))
};
goog.ui.PopupMenu.prototype.createAttachTarget = function(a, b, c, d, e) {
  if(!a) {
    return null
  }
...
goog.ui.PopupMenu.prototype.getAttachTarget = function(a) {
  return a ? this.targets_.get(goog.getUid(a)) : null
};
goog.ui.PopupMenu.prototype.isAttachTarget = function(a) {
  return a ? this.targets_.containsKey(goog.getUid(a)) : false
};
...
goog.ui.PopupMenu.prototype.detachAll = function() {
  if(this.isInDocument()) {
    for(var a = this.targets_.getKeys(), b = 0;b < a.length;b++) {
      this.detachEvent_(this.targets_.get(a[b]))
    }
  }
  this.targets_.clear()
};
goog.ui.PopupMenu.prototype.detach = function(a) {
  if(!this.isAttachTarget(a)) {
...
goog.ui.PopupMenu.prototype.setToggleMode = function(a) {
  this.toggleMode_ = a
};
...
goog.ui.PopupMenu.prototype.showWithPosition = function(a, b, c, d) {
  ...
  if((e || this.wasRecentlyHidden()) && this.toggleMode_) {
    ...
    if(this.currentAnchor_ = d || null, this.dispatchEvent(goog.ui.Component.EventType.BEFORE_SHOW)) {
      b = typeof b != "undefined" ? b : goog.positioning.Corner.TOP_START;
      if(!e) {
        this.getElement().style.visibility = "hidden"
      }
      goog.style.showElement(this.getElement(), true);
      a.reposition(this.getElement(), b, c);
      if(!e) {
...
goog.ui.PopupMenu.prototype.showMenu = function(a, b, c) {
  this.showWithPosition(goog.isDef(a.targetCorner_) ? new goog.positioning.AnchoredViewportPosition(a.element_, a.targetCorner_, true) : new goog.positioning.ViewportClientPosition(b, c), a.menuCorner_, a.margin_, a.element_)
};
goog.ui.PopupMenu.prototype.showAt = function(a, b, c) {
  this.showWithPosition(new goog.positioning.ViewportClientPosition(a, b), c)
};
goog.ui.PopupMenu.prototype.showAtElement = function(a, b, c) {
  this.showWithPosition(new goog.positioning.MenuAnchoredPosition(a, b, true), c, null, a)
};
goog.ui.PopupMenu.prototype.hide = function() {
  if(this.isVisible() && (this.setVisible(false), !this.isVisible())) {
...
goog.ui.PopupMenu.prototype.onTargetClick_ = function(a) {
...
goog.ui.PopupMenu.prototype.onDocClick = function(a) {
  this.isVisible() && !this.containsElement(a.target) && this.hide()
};
goog.ui.PopupMenu.prototype.handleBlur = function(a) {
  goog.ui.PopupMenu.superClass_.handleBlur.call(this, a);
  this.hide()
};
      ...
      var d = null, e = function(d, e) {
        ...
        switch(arguments.length) {
          ...
          case 1:
            ...
            o = d;
            var r = a.call(null, o);
            cljs.core.truth_(r) ? o = r : (r = b.call(null, o), o = cljs.core.truth_(r) ? r : c.call(null, o));
            return o;
          case 2:
...
var submenus2 = {setup:function() {
  var a = new goog.ui.PopupMenu, b = new goog.ui.Menu, c = new goog.ui.Menu, d = new goog.ui.SubMenu("Shared sub one"), e = new goog.ui.SubMenu("Shared sub four"), f = new goog.ui.SubMenu("Zero"), g = new goog.ui.SubMenu("Ten"), h = new goog.ui.SubMenu("Twenty"), i = new goog.ui.SubMenu("Thirty"), j = new goog.ui.SubMenu("Has shared one"), k = new goog.ui.SubMenu("Has shared two"), l = new goog.ui.SubMenu("Has shared three"), m = new goog.ui.SubMenu("Has decorated shared one"), p = new goog.ui.SubMenu("Has decorated shared two"), 
  n = new goog.ui.SubMenu("Has decorated shared three"), q = new goog.ui.SubMenu("One"), o = new goog.ui.SubMenu("Twenty-one"), r = new goog.ui.SubMenu("More"), s = new goog.ui.MenuItem("CcCcCcCcCcCc");
  a.attach(goog.dom.getElement.call(null, "button"), goog.positioning.Corner.BOTTOM_LEFT, goog.positioning.Corner.TOP_LEFT);
  b.decorate(goog.dom.getElement.call(null, "sharedMenu"));
  d.addItem(new goog.ui.MenuItem("Shared sub sub one"));
  d.addItem(new goog.ui.MenuItem("Shared sub sub two"));
  e.setMenu(b);
  c.addItem(d);
  c.addItem(new goog.ui.MenuItem("Shared sub two"));
  c.addItem(new goog.ui.MenuItem("Shared sub three"));
  c.addItem(e);
  e = cljs.core.seq.call(null, cljs.core.Vector.fromArray([j, k, l]));
  if(cljs.core.truth_(e)) {
    for(d = cljs.core.first.call(null, e);;) {
      if(d.setMenu(c), d = cljs.core.next.call(null, e), cljs.core.truth_(d)) {
  ...
  d = cljs.core.seq.call(null, cljs.core.Vector.fromArray([m, p, n]));
  if(cljs.core.truth_(d)) {
    for(c = cljs.core.first.call(null, d);;) {
      if(c.setMenu(b), c = cljs.core.next.call(null, d), cljs.core.truth_(c)) {
  ...
  q.setEnabled(false);
  q.addItem(new goog.ui.MenuItem("Add"));
  q.addItem(new goog.ui.MenuItem("Subtract"));
  q.addItem(new goog.ui.MenuItem("Multiply"));
  f.addItem(q);
  f.addItem(new goog.ui.MenuItem("Two"));
  f.addItem(new goog.ui.MenuItem("Three"));
  f.addItem(new goog.ui.MenuItem("Four"));
  g.addItem(new goog.ui.MenuItem("Eleven"));
  g.addItem(new goog.ui.MenuItem("Thirteen"));
  g.addItem(new goog.ui.MenuItem("Fourteen"));
  g.addItem(new goog.ui.MenuItem("Fifteen"));
  h.addItem(new goog.ui.MenuItem("Twenty-one"));
  o.addItem(new goog.ui.MenuItem("Add"));
  o.addItem(new goog.ui.MenuItem("Subtract"));
  o.addItem(new goog.ui.MenuItem("Multiply"));
  r.addItem(new goog.ui.MenuItem("Square Root"));
  r.addItem(new goog.ui.MenuItem("Power"));
  r.addItem(new goog.ui.MenuItem("Square"));
  o.addItem(r);
  h.addItem(o);
  h.addItem(new goog.ui.MenuItem("Twenty-three"));
  h.addItem(new goog.ui.MenuItem("Twenty-four"));
  i.addItem(new goog.ui.MenuItem("Twenty-one"));
  i.addItem(new goog.ui.MenuItem("Twenty-two"));
  i.addItem(new goog.ui.MenuItem("Twenty-three"));
  i.addItem(new goog.ui.MenuItem("Twenty-four"));
  s.setEnabled(false);
  a.addItem(f);
  a.addItem(new goog.ui.MenuItem("AaAaAaAaAaAa"));
  a.addItem(new goog.ui.MenuItem("BbBbBbBbBbBb"));
  a.addItem(g);
  a.addItem(h);
  a.addItem(i);
  a.addItem(j);
  ...
  a.addItem(n);
  a.addItem(s);
  a.addItem(new goog.ui.MenuItem("DdDdDdDdDdDd"));
  a.render();
  a.getElement().id = "foo";
  return goog.events.listen(a, "action", function(a) {
    a = a.target.getCaption();
    return alert.call(null, a)
  })
}};
goog.exportSymbol("submenus2.setup", submenus2.setup);
