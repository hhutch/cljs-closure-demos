...
goog.ui.ServerChart = function(a, b, c, d, e) {
  goog.ui.Component.call(this, d);
  this.uri_ = new goog.Uri(e || goog.ui.ServerChart.CHART_SERVER_URI);
...
goog.ui.ServerChart.prototype.createDom = function() {
  var a = this.getSize();
  this.setElementInternal(this.getDomHelper().createDom("img", {src:this.getUri(), "class":"goog-serverchart-image", width:a[0], height:a[1]}))
};
goog.ui.ServerChart.prototype.decorateInternal = function(a) {
  a.src = this.getUri();
...
goog.ui.ServerChart.prototype.setUri = function(a) {
  this.uri_ = a
};
...
goog.ui.ServerChart.prototype.setUriLengthLimit = function(a) {
  this.uriLengthLimit_ = a
};
goog.ui.ServerChart.prototype.setGridParameter = function(a) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.GRID, a)
};
...
goog.ui.ServerChart.prototype.setMarkerParameter = function(a) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MARKERS, a)
};
...
goog.ui.ServerChart.prototype.setMiscParameter = function(a) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MISC_PARAMS, String(a))
};
...
goog.ui.ServerChart.prototype.setBackgroundFill = function(a) {
  var b = [];
  goog.array.forEach(a, function(a) {
    a.area = a.area || "bg";
    a.effect = a.effect || "s";
    b.push([a.area, a.effect, a.color].join(","))
  });
  b = b.join("|");
  this.setParameterValue(goog.ui.ServerChart.UriParam.BACKGROUND_FILL, b)
};
goog.ui.ServerChart.prototype.getBackgroundFill = function() {
  var a = this.uri_.getParameterValue(goog.ui.ServerChart.UriParam.BACKGROUND_FILL), b = [];
  if(goog.isDefAndNotNull(a)) {
    var a = a.split("|"), c = true;
    goog.array.forEach(a, function(a) {
      a = a.split(",");
      c && a[1] == "s" ? b.push({area:a[0], effect:a[1], color:a[2]}) : (b = [], c = false)
    })
  }
  return b
};
goog.ui.ServerChart.prototype.setEncodingType = function(a) {
  this.encodingType_ = a
};
goog.ui.ServerChart.prototype.getEncodingType = function() {
  return this.encodingType_
};
goog.ui.ServerChart.prototype.setType = function(a) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.TYPE, a)
};
goog.ui.ServerChart.prototype.getType = function() {
  return this.uri_.getParameterValue(goog.ui.ServerChart.UriParam.TYPE)
};
goog.ui.ServerChart.prototype.setSize = function(a, b) {
  var c = [a || 300, b || 150].join("x");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.SIZE, c)
};
goog.ui.ServerChart.prototype.getSize = function() {
  return this.uri_.getParameterValue(goog.ui.ServerChart.UriParam.SIZE).split("x")
};
goog.ui.ServerChart.prototype.setMinValue = function(a) {
  this.minValue_ = a
};
goog.ui.ServerChart.prototype.getMinValue = function() {
  return this.minValue_
};
goog.ui.ServerChart.prototype.setMaxValue = function(a) {
  this.maxValue_ = a
};
goog.ui.ServerChart.prototype.getMaxValue = function() {
  return this.maxValue_
};
goog.ui.ServerChart.prototype.setMargins = function(a, b, c, d) {
  a = [a, b, c, d].join(",");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MARGINS, a)
};
goog.ui.ServerChart.prototype.setGridX = function(a) {
  this.gridX_ = a;
...
goog.ui.ServerChart.prototype.setGridY = function(a) {
  this.gridY_ = a;
  this.setGrids_(this.gridX_, this.gridY_)
};
...
goog.ui.ServerChart.prototype.setGrids_ = function(a, b) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.GRID, [a == 0 ? 0 : 100 / a, b == 0 ? 0 : 100 / b].join(","))
};
goog.ui.ServerChart.prototype.setXLabels = function(a) {
  this.xLabels_ = a;
...
goog.ui.ServerChart.prototype.isBarChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.BAR || a == goog.ui.ServerChart.ChartType.HORIZONTAL_GROUPED_BAR || a == goog.ui.ServerChart.ChartType.HORIZONTAL_STACKED_BAR || a == goog.ui.ServerChart.ChartType.VERTICAL_GROUPED_BAR || a == goog.ui.ServerChart.ChartType.VERTICAL_STACKED_BAR
};
goog.ui.ServerChart.prototype.isPieChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.PIE || a == goog.ui.ServerChart.ChartType.PIE3D || a == goog.ui.ServerChart.ChartType.CONCENTRIC_PIE
};
goog.ui.ServerChart.prototype.isGroupedBarChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.HORIZONTAL_GROUPED_BAR || a == goog.ui.ServerChart.ChartType.VERTICAL_GROUPED_BAR
};
goog.ui.ServerChart.prototype.isHorizontalBarChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.BAR || a == goog.ui.ServerChart.ChartType.HORIZONTAL_GROUPED_BAR || a == goog.ui.ServerChart.ChartType.HORIZONTAL_STACKED_BAR
};
goog.ui.ServerChart.prototype.isLineChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.FILLEDLINE || a == goog.ui.ServerChart.ChartType.LINE || a == goog.ui.ServerChart.ChartType.SPARKLINE || a == goog.ui.ServerChart.ChartType.XYLINE
};
goog.ui.ServerChart.prototype.isMap = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.MAP || a == goog.ui.ServerChart.ChartType.MAPUSA || a == goog.ui.ServerChart.ChartType.MAPWORLD
};
goog.ui.ServerChart.prototype.isStackedBarChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.BAR || a == goog.ui.ServerChart.ChartType.HORIZONTAL_STACKED_BAR || a == goog.ui.ServerChart.ChartType.VERTICAL_STACKED_BAR
};
goog.ui.ServerChart.prototype.isVerticalBarChart = function() {
  var a = this.getType();
  return a == goog.ui.ServerChart.ChartType.VERTICAL_GROUPED_BAR || a == goog.ui.ServerChart.ChartType.VERTICAL_STACKED_BAR
};
goog.ui.ServerChart.prototype.setLeftLabels = function(a) {
  this.leftLabels_ = a;
...
goog.ui.ServerChart.prototype.setParameterValue = function(a, b) {
  this.uri_.setParameterValue(a, b)
};
goog.ui.ServerChart.prototype.removeParameter = function(a) {
  this.uri_.removeParameter(a)
};
goog.ui.ServerChart.prototype.setRightLabels = function(a) {
  this.rightLabels_ = a;
...
goog.ui.ServerChart.prototype.setLegendPosition = function(a) {
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.LEGEND_POSITION, a)
};
...
goog.ui.ServerChart.prototype.setVennSeries = function(a, b, c) {
  ...
  goog.isDef(b) && (goog.array.forEach(b, goog.bind(function(a) {
    this.setLegendTexts_.push(a)
  }, this)), this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.LEGEND_TEXTS, this.setLegendTexts_.join("|")));
  a.length == 3 && (a[3] = a[2], a[2] = 0);
  this.dataSets_.push(a);
  goog.isDef(c) && (goog.array.forEach(c, goog.bind(function(a) {
    this.setColors_.push(a)
  }, this)), this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.DATA_COLORS, this.setColors_.join(",")))
};
goog.ui.ServerChart.prototype.setTitle = function(a) {
  this.title_ = a;
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.TITLE, this.title_.replace(/\n/g, "|"))
};
goog.ui.ServerChart.prototype.setTitleSize = function(a) {
  this.titleSize_ = a;
...
goog.ui.ServerChart.prototype.setTitleColor = function(a) {
  this.titleColor_ = a;
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.TITLE_FORMAT, this.titleColor_ + "," + this.titleSize_)
};
...
goog.ui.ServerChart.prototype.setLegend = function(a) {
  this.legend_ = a;
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.LEGEND, this.legend_.join("|"))
};
goog.ui.ServerChart.prototype.setDataScaling = function(a, b) {
  this.encodingType_ = goog.ui.ServerChart.EncodingType.TEXT;
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.DATA_SCALING, a + "," + b)
};
goog.ui.ServerChart.prototype.setBarSpaceWidths = function(a, b, c) {
  a = [a];
  goog.isDef(b) && a.push(b);
  goog.isDef(c) && a.push(c);
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.BAR_HEIGHT, a.join(","))
};
goog.ui.ServerChart.prototype.setAutomaticBarWidth = function(a, b) {
  var c = ["a"];
  goog.isDef(a) && c.push(a);
  goog.isDef(b) && c.push(b);
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.BAR_HEIGHT, c.join(","))
};
goog.ui.ServerChart.prototype.addMultiAxis = function(a) {
  this.multiAxisType_.push(a);
...
goog.ui.ServerChart.prototype.getMultiAxisType = function(a) {
  return goog.isDef(a) ? this.multiAxisType_[a] : this.multiAxisType_
};
goog.ui.ServerChart.prototype.setMultiAxisLabelText = function(a, b) {
  this.multiAxisLabelText_[a] = b;
  var c = this.computeMultiAxisDataString_(this.multiAxisLabelText_, ":|", "|", "|");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MULTI_AXIS_LABEL_TEXT, c)
};
goog.ui.ServerChart.prototype.getMultiAxisLabelText = function(a) {
  return goog.isDef(a) ? this.multiAxisLabelText_[a] : this.multiAxisLabelText_
};
goog.ui.ServerChart.prototype.setMultiAxisLabelPosition = function(a, b) {
  this.multiAxisLabelPosition_[a] = b;
  var c = this.computeMultiAxisDataString_(this.multiAxisLabelPosition_, ",", ",", "|");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MULTI_AXIS_LABEL_POSITION, c)
};
goog.ui.ServerChart.prototype.getMultiAxisLabelPosition = function(a) {
  return goog.isDef(a) ? this.multiAxisLabelPosition_[a] : this.multiAxisLabelPosition_
};
goog.ui.ServerChart.prototype.setMultiAxisRange = function(a, b, c, d) {
  goog.asserts.assert(b != c, "Range start and end cannot be the same value.");
  goog.asserts.assert(isFinite(b) && isFinite(c), "Range start and end must be finite numbers.");
  this.multiAxisRange_[a] = [b, c];
  goog.isDef(d) && this.multiAxisRange_[a].push(d);
  a = this.computeMultiAxisDataString_(this.multiAxisRange_, ",", ",", "|");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MULTI_AXIS_RANGE, a)
};
goog.ui.ServerChart.prototype.getMultiAxisRange = function(a) {
  return goog.isDef(a) ? this.multiAxisRange_[a] : this.multiAxisRange_
};
goog.ui.ServerChart.prototype.setMultiAxisLabelStyle = function(a, b, c, d, e) {
  b = [b];
  if(goog.isDef(c) || goog.isDef(d)) {
    b.push(c || "")
  }
  goog.isDef(d) && b.push(d);
  e && b.push(e);
  this.multiAxisLabelStyle_[a] = b;
  a = this.computeMultiAxisDataString_(this.multiAxisLabelStyle_, ",", ",", "|");
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.MULTI_AXIS_STYLE, a)
};
goog.ui.ServerChart.prototype.getMultiAxisLabelStyle = function(a) {
  return goog.isDef(a) ? this.multiAxisLabelStyle_[a] : this.multiAxisLabelStyle_
};
goog.ui.ServerChart.prototype.addDataSet = function(a, b, c) {
  var d = this.arrayMin_(a);
  if(d < this.minValue_) {
    this.minValue_ = d
  }
...
goog.ui.ServerChart.prototype.clearDataSets = function() {
  var a = this.uri_.getQueryData();
  a.remove(goog.ui.ServerChart.UriParam.LEGEND_TEXTS);
  a.remove(goog.ui.ServerChart.UriParam.DATA_COLORS);
  a.remove(goog.ui.ServerChart.UriParam.DATA);
  this.setLegendTexts_.length = 0;
  this.setColors_.length = 0;
  this.dataSets_.length = 0
};
goog.ui.ServerChart.prototype.getData = function(a) {
  return goog.isDef(a) ? this.dataSets_[a] : this.dataSets_
};
goog.ui.ServerChart.prototype.computeDataString_ = function() {
  var a;
  this.encodingType_ != goog.ui.ServerChart.EncodingType.AUTOMATIC ? a = this.computeDataStringForEncoding_(this.encodingType_) : (a = this.computeDataStringForEncoding_(goog.ui.ServerChart.EncodingType.EXTENDED)) || (a = this.computeDataStringForEncoding_(goog.ui.ServerChart.EncodingType.SIMPLE));
  a || this.dispatchEvent(new goog.ui.ServerChart.UriTooLongEvent(this.uri_.toString()))
};
goog.ui.ServerChart.prototype.computeDataStringForEncoding_ = function(a) {
  for(var b = [], c = 0, d = this.dataSets_.length;c < d;++c) {
    b[c] = this.getChartServerValues_(this.dataSets_[c], this.minValue_, this.maxValue_, a)
  }
  b = b.join(a == goog.ui.ServerChart.EncodingType.TEXT ? "|" : ",");
  a = this.numVisibleDataSets_ == null ? goog.string.buildString(a, ":", b) : goog.string.buildString(a, this.numVisibleDataSets_, ":", b);
  this.uri_.setParameterValue(goog.ui.ServerChart.UriParam.DATA, a);
  return this.uri_.toString().length < this.uriLengthLimit_
};
goog.ui.ServerChart.prototype.computeMultiAxisDataString_ = function(a, b, c, d) {
  for(var e = [], f = 0, g = this.multiAxisType_.length;f < g;++f) {
    a[f] && e.push(f + b + a[f].join(c))
  }
  return e.join(d)
};
...
goog.ui.ServerChart.prototype.getConvertedValue_ = function(a, b, c, d) {
  goog.asserts.assert(b <= c, "minValue should be less than or equal to maxValue");
  var e = d == goog.ui.ServerChart.EncodingType.EXTENDED;
  if(goog.isNull(a) || !goog.isDef(a) || isNaN(a) || a < b || a > c) {
    return e ? "__" : "_"
  }
  if(d == goog.ui.ServerChart.EncodingType.TEXT) {
    return String(a)
  }
  d = goog.ui.ServerChart.DEFAULT_NORMALIZATION;
  c > b && (d = (a - b) / (c - b));
  if(e) {
    return a = goog.ui.ServerChart.CHART_VALUES_EXTENDED.length, b = goog.ui.ServerChart.EXTENDED_UPPER_BOUND, c = Math.floor(d * b % a), e = goog.ui.ServerChart.CHART_VALUES_EXTENDED, e.charAt(Math.floor(d * b / a)) + e.charAt(c)
  }
  d = Math.round(d * (goog.ui.ServerChart.CHART_VALUES.length - 1));
  return goog.ui.ServerChart.CHART_VALUES.charAt(d)
};
goog.ui.ServerChart.prototype.getChartServerValues_ = function(a, b, c, d) {
  for(var e = [], f = 0, g = a.length;f < g;++f) {
    e.push(this.getConvertedValue_(a[f], b, c, d))
  }
  return e.join(this.encodingType_ == goog.ui.ServerChart.EncodingType.TEXT ? "," : "")
};
goog.ui.ServerChart.prototype.arrayMin_ = function(a) {
...
goog.ui.ServerChart.prototype.arrayMax_ = function(a) {
  for(var b = -Infinity, c = 0, d = a.length;c < d;++c) {
    var e = a[c];
    e != null && e > b && (b = e)
  }
...
goog.ui.ServerChart.UriTooLongEvent = function(a) {
...
var serverchart = {clj__GT_js:function clj__GT_js(b) {
...
serverchart.setup = function() {
  var a = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.LINE), b = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.FINANCE), c = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.PIE, 350, 140), d = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.FILLEDLINE, 180, 104), e = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.BAR, 180, 104), f = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.VENN, 300, 200), g = function() {
    b.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([25, 28, 31, 30, 25, 21, 26, 39, 36, 28, 23, 26, 31, 38, 39, 28, 26])), "4582e7");
    return b.updateChart()
  };
  a.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([5, 15, 10, 25, 20, 49, 10, 25, 34, 25, 39, 44, 49, 59, 44])), "ff0000");
  a.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([90, 92, 98, 90, 52, 54, 54, 43, 72, 48, 51, 72, 48, 51]), "0000ff"));
  a.setXLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray("Jan,Feb,Mar,Jun,Jul,Aug".split(","))));
  a.setLeftLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([0, 25, 50, 75, 100])));
  a.setRightLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([0, 50, 100])));
  a.setMinValue("-50");
  a.decorate(goog.dom.getElement.call(null, "line_chart"));
  b.setRightLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray(["-0.25%", "0.00%", "+0.25%", "+0.50%"])));
  b.setMiscParameter(2);
  b.setMaxValue(100);
  b.setMinValue(0);
  b.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([43, 44, 48, 49, 52, 49, 48, 44, 43, 52, 49, 44, 43])), "da3b15");
  b.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([72, 66, 62, 49, 48, 43, 44, 49, 61, 67, 70, 62, 64, 70])), "f7a10a");
  b.render(goog.dom.getElement.call(null, "test2"));
  goog.events.listen(goog.dom.getElement.call(null, "update-finance"), goog.events.EventType.CLICK, function() {
    return g.call(null)
  });
  c.setMinValue(0);
  c.setMaxValue(100);
  c.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([7, 50, 3, 30, 3, 8])), "ff9900");
  c.setXLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray("Internet Explorer 7,Internet Explorer 6,Internet Explorer 5,Firefox,Mozilla,Other".split(","))));
  c.render(goog.dom.getElement.call(null, "test3"));
  d.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([11, 49, 61, 61, 66, 44, 61, 43])), "FF0000");
  d.setLeftLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray(["20K", "", "60K", "", "100K"])));
  d.setXLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray("M,J,J,A,S,O,N,D,J,F,M,A".split(","))));
  d.setMaxValue(100);
  d.render(goog.dom.getElement.call(null, "test4"));
  e.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([8, 23, 7])), "008000");
  e.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([31, 11, 7])), "ffcc33");
  e.addDataSet(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([2, 43, 70, 3, 43, 74])), "3072f3");
  e.setLeftLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray(",20K,,60K,,100K".split(","))));
  e.setXLabels(serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray(["O", "N", "D"])));
  e.setMaxValue(100);
  e.render(goog.dom.getElement.call(null, "test5"));
  a = serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray([80, 60, 40, 20, 20, 20, 5]));
  c = serverchart.clj__GT_js.call(null, cljs.core.Vector.fromArray(["C Hackers", "LISP Gurus", "Java Jockeys"]));
  f.setTitle("Google Employees");
  f.setVennSeries(a, c);
  f.render(goog.dom.getElement.call(null, "test6"));
  return f
};
goog.exportSymbol("serverchart.setup", serverchart.setup);
