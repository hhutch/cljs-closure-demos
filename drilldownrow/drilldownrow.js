...
goog.ui.DrilldownRow = function(a) {
  goog.ui.Component.call(this);
  a = a || {};
  this.html_ = a.html;
  this.expanded_ = typeof a.expanded != "undefined" ? a.expanded : true;
  this.loaded_ = typeof a.loaded != "undefined" ? a.loaded : true;
  this.decoratorFn_ = a.decorator || goog.ui.DrilldownRow.decorate;
  this.displayed_ = true
};
goog.inherits(goog.ui.DrilldownRow, goog.ui.Component);
goog.ui.DrilldownRow.sampleProperties = {html:"<tr><td>Sample</td><td>Sample</tr>", loaded:true, decorator:function(a, b) {
  goog.ui.DrilldownRow.decorate(a);
  var c = a.getElement();
  b.listen(c, "mouseover", function() {
    goog.dom.classes.add(c, "goog-drilldown-hover")
  });
  b.listen(c, "mouseout", function() {
    goog.dom.classes.remove(c, "goog-drilldown-hover")
  })
}};
...
goog.ui.DrilldownRow.prototype.canDecorate = function(a) {
  return a.tagName == "TR"
};
goog.ui.DrilldownRow.prototype.addChildAt = function(a, b, c) {
  goog.ui.DrilldownRow.superClass_.addChildAt.call(this, a, b, false);
  a.setDisplayable_(this.isVisible_() && this.isExpanded());
  c && !a.isInDocument() && a.render()
};
goog.ui.DrilldownRow.prototype.removeChild = function(a) {
  goog.dom.removeNode(a.getElement());
  goog.ui.DrilldownRow.superClass_.removeChild.call(this, a)
};
...
goog.ui.DrilldownRow.prototype.render = function() {
  if(arguments.length) {
    ...
    var b = a.previousRenderedChild_(this), b = b ? b.lastRenderedLeaf_().getElement() : a.getElement();
    (b = b.nextSibling) ? this.renderBefore(b) : (a = a.getElement().parentNode, goog.ui.DrilldownRow.superClass_.render.call(this, a))
  }
};
goog.ui.DrilldownRow.prototype.findIndex = function() {
  ...
  for(var b = 0;b < a.getChildCount();b++) {
    if(a.getChildAt(b) == this) {
      return b
    }
  }
};
...
goog.ui.DrilldownRow.prototype.setExpanded = function(a) {
  if(a != this.expanded_) {
    this.expanded_ = a, goog.dom.classes.toggle(this.getElement(), "goog-drilldown-expanded"), goog.dom.classes.toggle(this.getElement(), "goog-drilldown-collapsed"), this.isVisible_() && this.forEachChild(function(b) {
      b.setDisplayable_(a)
    })
  }
};
goog.ui.DrilldownRow.prototype.getDepth = function() {
  for(var a = this, b = 0;a instanceof goog.ui.DrilldownRow;a = a.getParent(), b++) {
  }
  return b
};
goog.ui.DrilldownRow.decorate = function(a) {
  var b = a.getDepth(), c = a.getElement();
  if(!c.cells) {
    throw Error("No cells");
  }
  var d = c.cells[0], b = a.getDomHelper().htmlToDocumentFragment('<div style="float: left; width: ' + b + 'em;"><div class=toggle style="width: 1em; float: right;">&nbsp;</div></div>');
  d.insertBefore(b, d.firstChild);
  goog.dom.classes.add(c, a.isExpanded() ? "goog-drilldown-expanded" : "goog-drilldown-collapsed");
  c = b.getElementsByTagName("div")[0];
  a.getHandler().listen(c, "click", function() {
    a.setExpanded(!a.isExpanded())
  })
};
goog.ui.DrilldownRow.prototype.setDisplayable_ = function(a) {
  a && !this.isInDocument() && this.render();
  if(this.displayed_ != a) {
    this.displayed_ = a;
    if(this.isInDocument()) {
      this.getElement().style.display = a ? "" : "none"
    }
    var b = this;
    this.forEachChild(function(c) {
      c.setDisplayable_(a && b.expanded_)
    })
  }
};
goog.ui.DrilldownRow.prototype.isVisible_ = function() {
  for(var a = this;a instanceof goog.ui.DrilldownRow;a = a.getParent()) {
    if(!a.displayed_) {
      return false
    }
  }
...
goog.ui.DrilldownRow.createRowNode_ = function(a, b) {
  var c = "<table>" + a + "</table>", d = b.createElement("div");
  d.innerHTML = c;
  return d.firstChild.rows[0]
};
goog.ui.DrilldownRow.prototype.lastRenderedLeaf_ = function() {
  for(var a = null, b = this;b && b.isInDocument();b = b.getChildAt(b.getChildCount() - 1)) {
    a = b
  }
  return a
};
goog.ui.DrilldownRow.prototype.previousRenderedChild_ = function(a) {
  for(var b = this.getChildCount() - 1;b >= 0;b--) {
    if(this.getChildAt(b) == a) {
      for(var c = b - 1;c >= 0;c--) {
...
var drilldownrow = {setup:function() {
  var a = goog.dom.getElement.call(null, "firstRow"), b = new goog.ui.DrilldownRow(cljs.core.ObjMap.fromObject([], {}).strobj), c = new goog.ui.DrilldownRow(cljs.core.ObjMap.fromObject(["html"], {html:"<tr><td>Second row</td><td>Second column</td></tr>"}).strobj), d = new goog.ui.DrilldownRow(cljs.core.ObjMap.fromObject(["html"], {html:"<tr><td>Third row</td><td>Second column</td></tr>"}).strobj), e = new goog.ui.DrilldownRow(cljs.core.ObjMap.fromObject(["html"], {html:"<tr><td>Fourth row</td><td>Second column</td></tr>"}).strobj), 
  f = new goog.ui.DrilldownRow(goog.ui.DrilldownRow.sampleProperties);
  b.decorate(a);
  b.addChild(c, true);
  b.addChild(d, true);
  d.addChild(e, true);
  return d.addChild(f, true)
}};
goog.exportSymbol("drilldownrow.setup", drilldownrow.setup);
