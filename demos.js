...
var demos = {setup:function() {
  var a = goog.dom.getElementsByClass.call(null, "demo"), b = cljs.core.seq.call(null, cljs.core.range.call(null, a.length));
  if(cljs.core.truth_(b)) {
    for(var c = cljs.core.first.call(null, b);;) {
      if(c = a.item(c), c.getAttribute("href"), cljs.core.truth_(c.className.match(RegExp.call(null, cljs.core.str.call(null, "(\\s|^)", "inactive", "(\\s|$)")))) && goog.dom.setProperties.call(null, c, cljs.core.ObjMap.fromObject(["href"], {href:null}).strobj), c = cljs.core.next.call(null, b), cljs.core.truth_(c)) {
...
goog.exportSymbol("demos.setup", demos.setup);
