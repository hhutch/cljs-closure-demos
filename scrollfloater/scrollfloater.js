...
goog.ui.ScrollFloater = function(a, b) {
  var c = a ? goog.dom.getDomHelper(a) : b;
  goog.ui.Component.call(this, c);
  this.parentElement_ = a || this.getDomHelper().getDocument().body;
...
goog.ui.ScrollFloater.PLACEHOLDER_STYLE_PROPS_ = "position,top,left,display,cssFloat,marginTop,marginLeft,marginRight,marginBottom".split(",");
...
goog.ui.ScrollFloater.prototype.decorateInternal = function(a) {
  goog.ui.ScrollFloater.superClass_.decorateInternal.call(this, a);
  goog.dom.classes.add(a, goog.ui.ScrollFloater.CSS_CLASS_)
};
...
goog.ui.ScrollFloater.prototype.setScrollingEnabled = function(a) {
  (this.scrollingEnabled_ = a) ? (this.applyIeBgHack_(), this.update_()) : this.stopFloating_()
};
...
goog.ui.ScrollFloater.prototype.update_ = function() {
  this.scrollingEnabled_ && (this.getDomHelper().getDocument(), this.getDomHelper().getDocumentScroll().y > this.originalOffset_ ? this.startFloating_() : this.stopFloating_())
};
goog.ui.ScrollFloater.prototype.startFloating_ = function() {
  if(!this.floating_) {
    var a = this.getElement();
    this.getDomHelper().getDocument();
    var b = goog.style.getPageOffsetLeft(a), c = goog.style.getContentBoxSize(a).width;
    this.originalStyles_ = {};
    goog.object.forEach(goog.ui.ScrollFloater.STORED_STYLE_PROPS_, function(b) {
      this.originalStyles_[b] = a.style[b]
    }, this);
    goog.object.forEach(goog.ui.ScrollFloater.PLACEHOLDER_STYLE_PROPS_, function(b) {
      this.placeholder_.style[b] = a.style[b] || goog.style.getCascadedStyle(a, b) || goog.style.getComputedStyle(a, b)
    }, this);
    goog.style.setSize(this.placeholder_, a.offsetWidth, a.offsetHeight);
    goog.style.setStyle(a, {left:b + "px", width:c + "px", cssFloat:"none"});
    a.parentNode.replaceChild(this.placeholder_, a);
    this.parentElement_.appendChild(a);
    this.needsIePositionHack_() ? (a.style.position = "absolute", a.style.setExpression("top", 'document.compatMode=="CSS1Compat"?documentElement.scrollTop:document.body.scrollTop')) : (a.style.position = "fixed", a.style.top = "0");
    this.floating_ = true
  }
};
goog.ui.ScrollFloater.prototype.stopFloating_ = function() {
  if(this.floating_) {
    ...
    for(b in this.originalStyles_) {
      a.style[b] = this.originalStyles_[b]
    }
    this.needsIePositionHack_() && a.style.removeExpression("top");
    this.placeholder_.parentNode.replaceChild(a, this.placeholder_);
...
goog.ui.ScrollFloater.prototype.applyIeBgHack_ = function() {
  if(this.needsIePositionHack_()) {
    var a = this.getDomHelper().getDocument(), a = goog.style.getClientViewportElement(a);
    if(a.currentStyle.backgroundImage == "none") {
      a.style.backgroundImage = this.getDomHelper().getWindow().location.protocol == "https:" ? "url(https:///)" : "url(about:blank)", a.style.backgroundAttachment = "fixed"
    }
  }
};
var cljs = {core:{}};
...
var scrollfloater = {setup:function() {
  goog.dom.getElementsByTagNameAndClass.call(null, "form").item(0);
  var a = new goog.ui.ScrollFloater, b = new goog.ui.ToggleButton("Enable Floater 1"), c = new goog.ui.ScrollFloater, d = new goog.ui.ToggleButton("Enable Floater 2"), e = function(a, b) {
    return goog.events.listen(a, goog.ui.Component.EventType.ACTION, function() {
      return b.setScrollingEnabled(a.isChecked())
    })
  };
  b.render(goog.dom.getElement.call(null, "floater1"));
  a.decorate(goog.dom.getElement.call(null, "floater1"));
  c.addChild(d, true);
  c.render(goog.dom.getElement.call(null, "floater2container"));
  b.setState(goog.ui.Component.State.CHECKED);
  d.setState(goog.ui.Component.State.CHECKED);
  e.call(null, b, a);
  return e.call(null, d, c)
}};
goog.exportSymbol("scrollfloater.setup", scrollfloater.setup);
