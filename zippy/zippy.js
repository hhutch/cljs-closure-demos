...
goog.ui.Zippy = function(a, b, c, d, e) {
  function f(a) {
    if(a) {
      a.tabIndex = 0, goog.events.listen(a, goog.events.EventType.CLICK, g.onHeaderClick_, false, g), goog.events.listen(a, goog.events.EventType.KEYDOWN, g.onHeaderKeyDown_, false, g)
    }
  }
  goog.events.EventTarget.call(this);
...
goog.ui.Zippy.prototype.setExpanded = function(a) {
  if(this.elContent_) {
    goog.style.showElement(this.elContent_, a)
  }else {
    if(a && this.lazyCreateFunc_) {
...
goog.ui.Zippy.prototype.updateHeaderClassName = function(a) {
  this.elHeader_ && (goog.dom.classes.enable(this.elHeader_, "goog-zippy-expanded", a), goog.dom.classes.enable(this.elHeader_, "goog-zippy-collapsed", !a))
};
goog.ui.Zippy.prototype.onHeaderKeyDown_ = function(a) {
  if(a.keyCode == goog.events.KeyCodes.ENTER || a.keyCode == goog.events.KeyCodes.SPACE) {
    this.toggle(), a.preventDefault(), a.stopPropagation()
  }
};
...
goog.ui.AnimatedZippy.prototype.setExpanded = function(a) {
  if(this.isExpanded() != a || this.anim_) {
    ...
    this.anim_ ? (a = this.isExpanded(), goog.events.removeAll(this.anim_), this.anim_.stop(false), c = parseInt(this.getContentElement().style.marginTop, 10), c = b - Math.abs(c)) : c = a ? 0 : b;
    this.updateHeaderClassName(a);
    ...
    goog.events.listen(this.anim_, goog.fx.Animation.EventType.END, goog.bind(this.onAnimationCompleted_, this, a));
...
var zippy = {setup:function() {
  goog.debug.LogManager.getRoot().setLevel(goog.debug.Logger.Level.ALL);
  var a = goog.debug.Logger.getLogger("zippy"), b = new goog.debug.DivConsole(clojure.browser.dom.get_element.call(null, "log")), c = new goog.object.getValues(goog.ui.Zippy.Events), d = function(b) {
    return a.info(cljs.core.str.call(null, '"', b.target.elHeader_.id, '" dispatched: ', b.type))
  }, e = new goog.ui.Zippy("header1", "content1"), f = new goog.ui.AnimatedZippy("header2", "content2", true), g = new goog.ui.AnimatedZippy("header3", "content3", false);
  b.setCapturing(true);
  a.fine(cljs.core.str.call(null, "Listening for:", cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, ", ", c)), "."));
  b = goog.events;
  b.listen(e, c, d);
  b.listen(f, c, d);
  b.listen(g, c, d);
  b.listen(f, goog.ui.Zippy.Events.TOGGLE, function(a) {
    return g.setExpanded(cljs.core.not.call(null, a.expanded))
  });
  return e.expand()
}};
goog.exportSymbol("zippy.setup", zippy.setup);
