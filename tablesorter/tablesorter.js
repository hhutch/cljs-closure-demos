...
goog.ui.TableSorter.prototype.enterDocument = function() {
  ...
  goog.events.listen(a, goog.events.EventType.CLICK, this.sort_, false, this)
};
...
var tablesorter = {setup:function() {
  var a = new goog.ui.TableSorter;
  a.decorate(goog.dom.getElement.call(null, "sortMe"));
  a.setSortFunction(1, goog.ui.TableSorter.alphaSort);
  a.setSortFunction(2, goog.ui.TableSorter.createReverseSort(goog.ui.TableSorter.numericSort));
  return a
}};
goog.exportSymbol("tablesorter.setup", tablesorter.setup);
