...
(defn ^:export prepenvironment 
  "Example of adding external CSS files using clojurescript"
  []
...
(defn ^:export buildtooltip [button-id tooltip-classname]
  (let [tooltip (goog.ui.AdvancedTooltip. button-id)]
    ...
    (. (goog.ui.AdvancedTooltip. "btn-nest") 
       (setHtml "Clicking<br> this<br> button<br> has no effect."))
    (goog.ui.Tooltip. "btn-close" "Closes tooltip")
    (.listen goog.events
             (goog.dom.getElement. "btn-close")
