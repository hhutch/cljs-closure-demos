...
(defn ^:export setupGauges []
  ...
  (let [gauge (goog.ui.Gauge. 300 200)
        gauge-set-value (fn [& _] 
                          (let [v (js/parseInt (.-value (dom/getElement "v1")))]
  ...
  ;; (let [gauge (goog.ui.Gauge. 200 200)
  ;;       custom-theme (js/Function.)]
  ;;   (goog.inherits custom-theme goog.ui.GaugeTheme)
  ;;   (. (.-prototype custom-theme) 
  ;;      (getInternalBorderFill 
  ;;       (fn [cx cy r] (goog.graphics.SolidFill. "#8080ff"))))
  ;;   (doto gauge
  ;;     (.setMinimum -30)
  ;;     (.setMaximum 30)
  ;;     (.setTicks 10 0)
