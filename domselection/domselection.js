...
var domselection = {};
domselection.is_syncing = cljs.core.atom.call(null, false);
domselection.sync = function(a) {
  cljs.core.reset_BANG_.call(null, domselection.is_syncing, true);
  var b = goog.dom.getElement.call(null, cljs.core.str.call(null, "textField", a));
  goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionStart", a)).value = goog.dom.selection.getStart(b);
  goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionEnd", a)).value = goog.dom.selection.getEnd(b);
  goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionText", a)).value = goog.dom.selection.getText(b);
  return cljs.core.reset_BANG_.call(null, domselection.is_syncing, false)
};
domselection.update = function(a) {
  cljs.core.reset_BANG_.call(null, domselection.is_syncing, true);
  var b = goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionStart", a)).value, c = goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionEnd", a)).value, d = goog.dom.getElement.call(null, cljs.core.str.call(null, "selectionText", a)).value, e = goog.dom.getElement.call(null, cljs.core.str.call(null, "textField", a));
  e.focus();
  cljs.core.truth_(cljs.core.not.call(null, isNaN.call(null, b))) && goog.dom.selection.setStart(e, b);
  cljs.core.truth_(cljs.core.not.call(null, isNaN.call(null, c))) && goog.dom.selection.setEnd(e, c);
  goog.dom.selection.setText(e, d);
  cljs.core.reset_BANG_.call(null, domselection.is_syncing, false);
  return domselection.sync.call(null, a)
};
domselection.setup = function() {
  domselection.sync.call(null, 1);
  domselection.sync.call(null, 2);
  goog.events.listen(goog.dom.getElement.call(null, "button1"), goog.events.EventType.CLICK, function() {
    return domselection.update.call(null, 1)
  });
  goog.events.listen(goog.dom.getElement.call(null, "button2"), goog.events.EventType.CLICK, function() {
    return domselection.update.call(null, 2)
  });
  goog.events.listen(goog.dom.getElement.call(null, "textField1"), "keydown", function() {
    return domselection.sync.call(null, 1)
  });
  goog.events.listen(goog.dom.getElement.call(null, "textField1"), "keyup", function() {
    return domselection.sync.call(null, 1)
  });
  goog.events.listen(goog.dom.getElement.call(null, "textField2"), "keydown", function() {
    return domselection.sync.call(null, 2)
  });
  return goog.events.listen(goog.dom.getElement.call(null, "textField2"), "keyup", function() {
    return domselection.sync.call(null, 2)
  })
};
goog.exportSymbol("domselection.setup", domselection.setup);
