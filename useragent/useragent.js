...
(function() {
  var a = false;
  goog.userAgent.IE ? (goog.global[goog.userAgent.picasa.IE_HAS_PICASA_] = a, document.write(goog.string.subs("<\!--[if gte Picasa 2]><%s>this.%s=true;</%s><![endif]--\>", "script", goog.userAgent.picasa.IE_HAS_PICASA_, "script")), a = goog.global[goog.userAgent.picasa.IE_HAS_PICASA_], goog.global[goog.userAgent.picasa.IE_HAS_PICASA_] = void 0) : navigator.mimeTypes && navigator.mimeTypes["application/x-picasa-detect"] && (a = true);
  goog.userAgent.picasa.HAS_PICASA = a;
  goog.userAgent.picasa.VERSION = a ? "2" : ""
})();
goog.userAgent.picasa.isVersion = function(a) {
  return goog.string.compareVersions(goog.userAgent.picasa.VERSION, a) >= 0
};
goog.dom = {};
...
(function() {
  ...
  if(goog.userAgent.IE) {
    ...
    if(navigator.mimeTypes && navigator.mimeTypes.length > 0 && (b = navigator.mimeTypes["application/pdf"]) && b.enabledPlugin) {
      (b = b.enabledPlugin.description) && b.indexOf("Adobe") != -1 && (a = b.indexOf("Version") != -1 ? b.split("Version")[1] : "7")
    }
  }
  goog.userAgent.adobeReader.HAS_READER = !!a;
  goog.userAgent.adobeReader.VERSION = a;
  goog.userAgent.adobeReader.SILENT_PRINT = goog.userAgent.WINDOWS && goog.string.compareVersions(a, "6") >= 0
})();
...
(function() {
  ...
  if(goog.userAgent.WEBKIT && navigator.mimeTypes && navigator.mimeTypes.length > 0) {
    ...
    if(c) {
      a = true, (c = c.description) && (b = c.match(/\d/g).join("."))
    }
  }
...
goog.userAgent.iphoto.isVersion = function(a) {
  return goog.string.compareVersions(goog.userAgent.iphoto.VERSION, a) >= 0
};
...
(function() {
  ...
  if(navigator.plugins && navigator.plugins.length) {
    ...
    d && (b = true, d.description && (c = a(d.description)));
    navigator.plugins["Shockwave Flash 2.0"] && (b = true, c = "2.0.0.11")
  }else {
    if(navigator.mimeTypes && navigator.mimeTypes.length) {
      (b = (d = navigator.mimeTypes["application/x-shockwave-flash"]) && d.enabledPlugin) && (c = a(d.enabledPlugin.description))
    }else {
      try {
        d = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7"), b = true, c = a(d.GetVariable("$version"))
      }catch(e) {
        try {
          d = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"), b = true, c = "6.0.21"
        }catch(f) {
          try {
            d = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), b = true, c = a(d.GetVariable("$version"))
          }catch(g) {
          }
        }
      }
  ...
  goog.userAgent.flash.HAS_FLASH = b;
  goog.userAgent.flash.VERSION = c
})();
goog.userAgent.flash.isVersion = function(a) {
  return goog.string.compareVersions(goog.userAgent.flash.VERSION, a) >= 0
};
goog.dom.classes = {};
...
var useragent = {clj__GT_js:function clj__GT_js(b) {
...
}, add_value:function(a, b, c) {
  var d = goog.dom.createElement.call(null, "tr"), e = goog.dom.createDom.call(null, "th", null, b), b = goog.dom.createElement.call(null, "td");
  goog.dom.appendChild.call(null, a, d);
  goog.dom.appendChild.call(null, d, e);
  goog.dom.appendChild.call(null, d, b);
  return cljs.core.truth_(new goog.isBoolean(c)) ? (a = cljs.core.truth_(cljs.core.true_QMARK_.call(null, c)) ? "yes" : "no", goog.dom.setTextContent.call(null, b, a), goog.dom.classes.set(b, a)) : (goog.dom.setTextContent.call(null, b, c), cljs.core.truth_(cljs.core.not.call(null, c)) ? goog.dom.classes.set(b, "no") : null)
}};
...
useragent.setup = function() {
  ...
  cljs.core.Vector.fromArray(["HAS_PICASA", "VERSION"])), f = useragent.clj__GT_js.call(null, cljs.core.Vector.fromArray(["HAS_IPHOTO", "VERSION"])), g = useragent.clj__GT_js.call(null, cljs.core.Vector.fromArray(["HAS_JSCRIPT", "VERSION"]));
  useragent.clj__GT_js.call(null, cljs.core.Vector.fromArray(["HAS_READER", "SILENT_PRINT", "VERSION"]));
  var h = goog.dom.getElement.call(null, "browserFields"), i = goog.dom.getElement.call(null, "featureFields");
  useragent.add_section.call(null, h, "Hardware Platform", goog.userAgent, a);
  useragent.add_section.call(null, h, "Renderer", goog.userAgent, b);
  useragent.add_section.call(null, h, "Product", goog.userAgent.product, c);
  useragent.add_section.call(null, i, "Adobe Reader Detection", goog.userAgent.adobeReader, useragent.adobeReader_fields);
  useragent.add_section.call(null, i, "Flash Plugin", goog.userAgent.flash, d);
  useragent.add_section.call(null, i, "iPhoto Detection", goog.userAgent.iphoto, f);
  useragent.add_section.call(null, i, "Microsoft JScript", goog.userAgent.jscript, g);
  return useragent.add_section.call(null, i, "Picasa Detection", goog.userAgent.picasa, e)
};
goog.exportSymbol("useragent.setup", useragent.setup);
