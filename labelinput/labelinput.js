...
var labelinput = {setup:function() {
  var a = new goog.ui.LabelInput, b = new goog.ui.LabelInput("Search, add, or invite 2");
  b.render(goog.dom.getElement.call(null, "d"));
  a.decorate(goog.dom.getElement.call(null, "i"));
  return b.getElement().name = "dynamic"
}};
goog.exportSymbol("labelinput.setup", labelinput.setup);
