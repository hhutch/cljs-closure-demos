...
var viewportsizemonitor = {setup:function() {
  var a = function(a) {
    goog.style.setSize.call(null, goog.dom.getElement.call(null, "demo"), a);
    return goog.dom.setTextContent.call(null, goog.dom.getElement.call(null, "current_size"), a.toString())
  }, b = new goog.dom.ViewportSizeMonitor;
  a.call(null, goog.dom.getViewportSize.call(null));
  return goog.events.listen.call(null, b, goog.events.EventType.RESIZE, function() {
    return a.call(null, b.getSize())
  })
}};
goog.exportSymbol("viewportsizemonitor.setup", viewportsizemonitor.setup);
