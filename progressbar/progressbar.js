...
goog.ui.RangeModel.prototype.setStep = function(a) {
  if(this.step_ != a) {
    this.step_ = a, a = this.isChanging_, this.isChanging_ = true, this.setMaximum(this.getMaximum()), this.setExtent(this.getExtent()), this.setValue(this.getValue()), this.isChanging_ = a, !this.isChanging_ && !this.mute_ && this.dispatchEvent(goog.ui.Component.EventType.CHANGE)
  }
};
...
goog.ui.ProgressBar = function(a) {
...
goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[goog.ui.ProgressBar.Orientation.VERTICAL] = "progress-bar-vertical";
goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[goog.ui.ProgressBar.Orientation.HORIZONTAL] = "progress-bar-horizontal";
goog.ui.ProgressBar.prototype.createDom = function() {
  this.thumbElement_ = this.createThumb_();
  var a = goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[this.orientation_];
  this.setElementInternal(this.getDomHelper().createDom("div", a, this.thumbElement_));
  this.setValueState_();
...
goog.ui.ProgressBar.prototype.createThumb_ = function() {
  return this.getDomHelper().createDom("div", "progress-bar-thumb")
};
goog.ui.ProgressBar.prototype.attachEvents_ = function() {
  goog.userAgent.IE && goog.userAgent.VERSION < 7 && goog.events.listen(this.getElement(), goog.events.EventType.RESIZE, this.updateUi_, false, this)
};
goog.ui.ProgressBar.prototype.detachEvents_ = function() {
  goog.userAgent.IE && goog.userAgent.VERSION < 7 && goog.events.unlisten(this.getElement(), goog.events.EventType.RESIZE, this.updateUi_, false, this)
};
goog.ui.ProgressBar.prototype.decorateInternal = function(a) {
  goog.ui.ProgressBar.superClass_.decorateInternal.call(this, a);
  goog.dom.classes.add(this.getElement(), goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[this.orientation_]);
  a = goog.dom.getElementsByTagNameAndClass(null, "progress-bar-thumb", this.getElement())[0];
  a || (a = this.createThumb_(), this.getElement().appendChild(a));
  this.thumbElement_ = a
};
goog.ui.ProgressBar.prototype.getValue = function() {
  return this.rangeModel_.getValue()
};
goog.ui.ProgressBar.prototype.setValue = function(a) {
  this.rangeModel_.setValue(a);
  this.getElement() && this.setValueState_()
};
...
goog.ui.ProgressBar.prototype.setMinimum = function(a) {
  this.rangeModel_.setMinimum(a);
  this.getElement() && this.setMinimumState_()
};
...
goog.ui.ProgressBar.prototype.setMaximum = function(a) {
  this.rangeModel_.setMaximum(a);
  this.getElement() && this.setMaximumState_()
};
...
goog.ui.ProgressBar.prototype.handleChange_ = function() {
  this.updateUi_();
  this.dispatchEvent(goog.ui.Component.EventType.CHANGE)
};
goog.ui.ProgressBar.prototype.updateUi_ = function() {
  if(this.thumbElement_) {
    var a = this.getMinimum(), b = this.getMaximum(), a = (this.getValue() - a) / (b - a), b = Math.round(a * 100);
    this.orientation_ == goog.ui.ProgressBar.Orientation.VERTICAL ? goog.userAgent.IE && goog.userAgent.VERSION < 7 ? (this.thumbElement_.style.top = 0, this.thumbElement_.style.height = "100%", b = this.thumbElement_.offsetHeight, a = Math.round(a * b), this.thumbElement_.style.top = b - a + "px", this.thumbElement_.style.height = a + "px") : (this.thumbElement_.style.top = 100 - b + "%", this.thumbElement_.style.height = b + "%") : this.thumbElement_.style.width = b + "%"
  }
};
goog.ui.ProgressBar.prototype.initializeUi_ = function() {
  var a = this.thumbElement_.style;
  this.orientation_ == goog.ui.ProgressBar.Orientation.VERTICAL ? (a.left = 0, a.width = "100%") : (a.top = a.left = 0, a.height = "100%")
};
goog.ui.ProgressBar.prototype.setOrientation = function(a) {
  if(this.orientation_ != a) {
    var b = goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[this.orientation_], c = goog.ui.ProgressBar.ORIENTATION_TO_CSS_NAME_[a];
    this.orientation_ = a;
    this.getElement() && (goog.dom.classes.swap(this.getElement(), b, c), this.initializeUi_(), this.updateUi_())
  }
};
...
goog.ui.ProgressBar.prototype.setStep = function(a) {
  this.rangeModel_.setStep(a)
};
var cljs = {core:{}};
...
var progressbar = {};
progressbar.delta = cljs.core.atom.call(null, 1);
progressbar.previous = cljs.core.atom.call(null, 0);
progressbar.setup = function() {
  var a = goog.dom.getElement, b = new goog.ui.ProgressBar, c = new goog.ui.ProgressBar, d = new goog.Timer(20);
  b.setOrientation(goog.ui.ProgressBar.Orientation.VERTICAL);
  b.render(new a("d"));
  c.decorate(new a("pb2"));
  d.addEventListener("tick", function() {
    cljs.core.truth_(function() {
      var a = cljs.core.deref.call(null, progressbar.previous) > 100;
      return cljs.core.truth_(a) ? a : cljs.core.deref.call(null, progressbar.previous) < 0
    }()) && cljs.core.swap_BANG_.call(null, progressbar.delta, cljs.core._);
    cljs.core.swap_BANG_.call(null, progressbar.previous, cljs.core._PLUS_, cljs.core.deref.call(null, progressbar.delta));
    b.setValue(cljs.core.deref.call(null, progressbar.previous));
    return c.setValue(cljs.core.deref.call(null, progressbar.previous))
  });
  d.start();
  return b.addEventListener(goog.ui.Component.EventType.CHANGE, function() {
    return goog.dom.setTextContent(new a("out"), cljs.core.str.call(null, this.getValue(), "%"))
  })
};
goog.exportSymbol("progressbar.setup", progressbar.setup);
