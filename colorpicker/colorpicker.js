...
var colorpicker = {setup:function() {
  var a = goog.ui.ColorPicker.createSimpleColorGrid();
  a.render(goog.dom.getElement.call(null, "colorpicker02"));
  goog.events.listen(a, goog.ui.ColorPicker.EventType.CHANGE, function(a) {
    var a = a.target.getSelectedColor(), a = cljs.core.truth_(a) ? a : "#000000", c = goog.dom.getElement.call(null, "picker02message");
    c.innerHTML = cljs.core.str.call(null, "You selected: ", a);
    return c.style.color = a
  });
  return goog.events.listen(goog.dom.getWindow.call(null), "unload", function() {
    return goog.events.removeAll()
  })
}};
goog.exportSymbol("colorpicker.setup", colorpicker.setup);
