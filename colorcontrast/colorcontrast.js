...
var colorcontrast = {clj__GT_js:function clj__GT_js(b) {
...
}, black_or_white:function() {
  var a = goog.dom.getElement.call(null, "color"), b = goog.dom.getElement.call(null, "preview"), c = goog.color.hexToRgbStyle(cljs.core.str.call(null, "#", a.value)), c = goog.color.parseRgb(c), c = goog.color.highContrast(c, colorcontrast.clj__GT_js.call(null, cljs.core.Vector.fromArray([cljs.core.Vector.fromArray([0, 0, 0]), cljs.core.Vector.fromArray([255, 255, 255])]))), c = goog.color.rgbArrayToHex(c);
  console.info(cljs.core.str.call(null, c, " wins on sum"));
  b.style.backgroundColor = cljs.core.str.call(null, "#", a.value);
  return b.style.color = c
}};
colorcontrast.setup = function() {
  return goog.events.listen(goog.dom.getElement.call(null, "submit"), goog.events.EventType.CLICK, function() {
    return colorcontrast.black_or_white.call(null)
  })
};
goog.exportSymbol("colorcontrast.setup", colorcontrast.setup);
